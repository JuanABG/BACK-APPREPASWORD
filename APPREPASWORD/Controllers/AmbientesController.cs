...
namespace APPREPASWORD.Controllers
{
    ...
    public class AmbientesController : ControllerBase
    {
        ...
        public AmbientesController(APPREPASWORDContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Ambiente>> PostAmbiente(Ambiente ambiente)
        {
          if (_context.Ambientes == null)
          {
              return Problem("Entity set 'APPREPASWORDContext.Ambientes'  is null.");
          }
        ...
        {
            return (_context.Ambientes?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
